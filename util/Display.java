...
public class Display {
    ...
    public static int menuOpcoes(Scanner scan, String titulo, List<Object> opcoes) {
        System.out.println("\n" + textoCharRepetido(titulo.length()));
    ...
    public static void pagina(Diretor usuario) throws InvocationTargetException, NoSuchMethodException, IllegalAccessException {
        ...
        while (true) {
            ...
            switch (menuOpcoes(
                ...
                case 19: {
                        ...
                        for (Curso curso : DadosCursos.getCursosCadastrados()) {
                            if (curso.getNome().equals(nomeCurso)) {
                                System.out.println("Já existe um curso com o nome informado!");
                                continue LOOP;
                            }
                        }
                    ...
                    System.out.println("Você irá adicionar os professores ao curso.\nQuando desejar parar, digite [0] (SAIR)");
                    System.out.println("Pressione [ENTER] para continuar");
                    PedirEntrada.pedirString(scan);

                        while (true) {
                            int opcao = menuOpcoes(scan, "Selecione o Professor que deseja adicionar ao Curso", Collections.singletonList(professores));
                            System.out.println();
                            if (opcao == 0) {
                                break;
                            }
                            ...
                            Professor professor = professores.get(opcao - 1);
                            curso.adicionaProfessor(professor);
                        }
                    try {
        ...
        public static void pagina (Professor professor) throws
        ...
        public static void pagina (Aluno aluno) throws
        InvocationTargetException, NoSuchMethodException, IllegalAccessException {
            Scanner scan = new Scanner(System.in);
            LOOP:
            while (true) {
